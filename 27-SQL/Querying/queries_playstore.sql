...
-- 8
SELECT * FROM analytics WHERE min_installs < 50 AND reviews != 0 ORDER BY rating DESC;
...
-- 15
SELECT *, min_installs / reviews as proportion FROM analytics WHERE min_installs >= 100000 ORDER BY proportion DESC LIMIT 1;